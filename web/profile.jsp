<%-- 
    Document   : profile
    Created on : Jan 8, 2018, 9:20:04 AM
    Author     : TGMaster
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 ">
                        <div class="container">
                            <form action="edit" method="POST" enctype="multipart/form-data">
                                <legend>User Profile Setting</legend>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <p class="form-control-static"><strong><%=u.getName()%></strong></p>
                                    </div>
                                </div>

                                <!-- Old Pass -->
                                <div class="form-group row <%if (error.length() > 0) {%> has-danger <%}%> ">
                                    <label for="oldpass" class="col-sm-3 col-form-label">* Current Password</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        <input type="password" class="form-control <%if (error.length() > 0) {%> form-control-danger <%}%> " id="oldpass" placeholder="Current Password" name="oldpass" required>
                                        <%if (error.length() > 0) {%>
                                        <div class="form-control-feedback"><i class="fa fa-close"></i> <%=error%></div>
                                        <%}%>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="password" class="form-control" id="newpass" placeholder="New Password" name="newpass" id="pass1">
                                    </div>
                                </div>

                                <!-- New Pass Confirm -->
                                <div class="form-group row">
                                    <label for="newpass2" class="col-sm-3 col-form-label">Confirm Password</label>
                                    <div class="col-sm-4 input-group">
                                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                        <input type="password" class="form-control" id="newpass2" placeholder="Re-enter Password" name="newpass2" id="pass2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="email" class="form-control" id="email" value="<%=u.getEmail()%>" name="email" required onchange="email_validate(this.value);">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="text" class="form-control" id="address" value="<%=u.getAddress()%>" name="address" required onkeyup = "add_validate(this.value)">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 input-group">
                                        ...
                                        <input type="text" class="form-control" id="dob" value="<%=u.getDOB()%>" name="dob" onkeyup = "dob_validate(this.value)">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-2 hidden-xs">
                        <img src="img/user/<%=u.getImage()%>" class="img-responsive img-thumbnail ">
                    </div>
